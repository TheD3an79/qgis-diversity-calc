...
from .diversity_functions import dc_summarisePoly, dc_mergeDictionaries, dc_resultString
import os.path
...
class DiversityCalc:
    ...
    def run(self):
        ...
        if self.first_start == True:
            ...
            # filters the layer selection to only polygon and point layers respectively
            ...
            # filters the field layers to only accept string fields
        ...
        if result:
            # get the layers set by the user in the dialog box
            lyrPoly = self.dlg.mcbPoly.currentLayer()
            lyrPoint = self.dlg.mcbPoint.currentLayer()

            # get the fields set by the user in the dialog box
            ...
            for poly in lyrPoly.getFeatures():
                ...
                dctSummary = dc_summarisePoly(poly, lyrPoint, fldSpecies)
